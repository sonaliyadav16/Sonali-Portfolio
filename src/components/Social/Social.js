    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/sonaliyadav16" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/sonali-yadav-39b43a227/" />
                <IconBtn icon={Email} m={1} href="mailto:sonaliyadav16jan@gmail.com" />
            </div>
        );
    } else {
        return (
